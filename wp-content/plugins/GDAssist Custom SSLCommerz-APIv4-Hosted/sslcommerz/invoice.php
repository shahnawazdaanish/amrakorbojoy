...
<div class="bg">
    ...
    <div class="card">
        ...
        <?php if(get('tran_status',$payment) == "Paid" || get('tran_status',$payment) == "Processing") {?>
            <span class="card__success"><i class="ion-checkmark"></i></span>
            <h1 class="card__msg">Donation <?php echo get('tran_status',$payment) == "Paid" || get('tran_status',$payment) == "Processing" ? 'Complete' : 'Fail' ?></h1>
...
<!--            <img src="http://nathgreen.co.uk/assets/img/nath.jpg" class="card__avatar">-->
            ...
            <div class="card__payment">
                <img src="<?php echo plugin_dir_url('/') . 'GDAssist Custom SSLCommerz-APIv4-Hosted/images/SSLCommerz.png' ; ?>"
                     class="card__credit-card">
                <div class="card__card-details">
                    <p class="card__card-type">SSLCommerz</p>
                    <p class="card__card-number">Payment Service Provider</p>
                </div>
            </div>
            <?php } ?>
        ...
        <div class="card__tags">
            <span class="card__tag"><?php echo get('tran_status',$payment) == "Paid" || get('tran_status',$payment) == "Processing" ? 'Completed' : 'Unpaid'; ?></span>
