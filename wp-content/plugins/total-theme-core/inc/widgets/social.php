...
if ( ! class_exists( 'WPEX_Social_Widget' ) ) {
	...
	class WPEX_Social_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'wpex_social_widget',
				$branding . esc_attr__( 'Social Profile Icons (Old)', 'total-theme-core' ),
				array(
		...
		public function form( $instance ) {
			...
			<p>
				...
				<select class='wpex-widget-select' name="<?php echo esc_attr( $this->get_field_name( 'target' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>">
					<option value="blank" <?php selected( $instance['target'], 'blank' ); ?>><?php esc_attr_e( 'Blank', 'total-theme-core' ); ?></option>
					<option value="self" <?php selected( $instance['target'], 'self' ); ?>><?php esc_attr_e( 'Self', 'total-theme-core' ); ?></option>
				</select>
			</p>
