		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<form name="frm1" id="frm1" method="POST" action="<?php echo $current_url; ?>">
					...
					<div class="form-group">
						<label style="color: #000000" for="name" class="col-sm-3">Name <span style="color:red;font-size:22px;">*</span></label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<label style="color: #000000" for="email" class="col-sm-3">Email <span style="color:red;font-size:22px;">*</span></label>
						<div class="col-sm-9">
