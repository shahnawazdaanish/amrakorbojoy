...
/* Topbar > Inner
-------------------------------------------------------------------------------*/
if ( 'two' == wpex_get_mod( 'top_bar_style', 'one' ) ) {
...
/* Outer Wrap > After
-------------------------------------------------------------------------------*/
add_action( 'wpex_outer_wrap_after', 'wpex_mobile_menu_alt' );
add_action( 'wpex_outer_wrap_after', 'wpex_mobile_searchform' );
add_action( 'wpex_outer_wrap_after', 'wpex_mobile_menu_extras' );
add_action( 'wpex_outer_wrap_after', 'wpex_scroll_top' );
add_action( 'wpex_outer_wrap_after', 'wpex_search_overlay' );
add_action( 'wpex_outer_wrap_after', 'wpex_sidr_close' );
