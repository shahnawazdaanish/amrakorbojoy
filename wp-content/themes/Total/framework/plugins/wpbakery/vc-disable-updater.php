...
function wpex_vc_license_tab_notice() {
	...
	if ( 'visual-composer_page_vc-updater' == $screen->id ) {
		echo '<div class="error"><p><strong>' . esc_html__( 'Activating the WPBakery Builder plugin is 100% optional and NOT required to function correctly with the theme.', 'total' ) . '</strong></p></div>';
	}
}
