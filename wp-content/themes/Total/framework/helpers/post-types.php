...
function wpex_get_staff_name() {
	...
	$name = $name ? $name : esc_html__( 'Staff', 'total' );
	return $name;
}
...
function wpex_get_staff_singular_name() {
	...
	$name = $name ? $name : esc_html__( 'Staff Member', 'total' );
	return $name;
}
...
function wpex_get_testimonials_name() {
	...
	$name = $name ? $name : esc_html__( 'Testimonials', 'total' );
	return $name;
}
...
function wpex_get_testimonials_singular_name() {
	...
	$name = $name ? $name : esc_html__( 'Testimonial', 'total' );
	return $name;
}
