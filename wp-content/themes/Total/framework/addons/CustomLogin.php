...
class WPEX_Custom_Login {
	...
	public function __construct() {
		...
		if ( is_admin() ) {
			...
			//add_filter( 'login_headertitle',array( $this, 'login_headertitle' ) ); // @deprecated in 5.2
		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				<table class="form-table wpex-tabs-wrapper">
					...
					<tr valign="top" class="wpex-tab-content wpex-main">
						<th scope="row"><?php esc_html_e( 'Custom Logo URL', 'total' ); ?></th>
						<td>
					...
					<tr valign="top" class="wpex-tab-content wpex-main">
						<th scope="row"><?php esc_html_e( 'Logo Screen Reader Text', 'total' ); ?></th>
						<td>
